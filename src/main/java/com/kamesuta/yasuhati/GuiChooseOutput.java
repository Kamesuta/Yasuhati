...
public class GuiChooseOutput extends Screen {
    ...
    public void render(MatrixStack stack, int mouseX, int mouseY, float partialTicks) {
        ...
        AbstractGui.drawCenteredString(stack, minecraft.fontRenderer, new TranslationTextComponent("sounddeviceoptions.newdevice"), this.width / 2, 6, 0xFFFFFF);
        AbstractGui.drawCenteredString(stack, minecraft.fontRenderer, new TranslationTextComponent("sounddeviceoptions.activedevice", TextFormatting.UNDERLINE + this.initalDevice + TextFormatting.RESET), this.width / 2, 18, 0xFFFFFF);
    ...
    public void onClose() {
        if (this.list.selectedIndex != startIndex) {
            ...
            minecraft.getSoundHandler().reload().soundEngine.reload();
        }
        super.onClose();
    }
